...
def main():
    ...
    while True:
        print("\n =============================")
        print("If you are a new player press 1,")
        print("          OTHERWISE ... press 2!")

        choice = int(input("So what is going to be?  "))

        if choice == 1:
            player = {}
            onoma = input("Give your name Honey: ")
            player_name = onoma
            player["name"] = onoma
            player["money"] = 5000
            ...
            player_name = input("What's your name again?: ")
            for i in range(len(players)):
                lexiko_i = dict(players[i])
                if player_name in lexiko_i.values():
                    money = lexiko_i.get("money")
            if money == 0:
                money = 5000
                print(money)
            break
    ...
    while True:  # Main game loop.
        ...
        print('You Have', money, "€", player_name.upper(),", good luck!\n")
        bet = getBet(money)
...
def getBet(maxBet):
    ...
    while True:  # Keep asking until they enter a valid amount.
        ...
        if bet == 'QUIT':
            print('==================================')
            print('Thanks for playing!')
            print('Your money-status have been saved!')
            print('See you again?.')
            print('==================================')
            sys.exit()
